...
export const config = {
  matcher: [
    ...
    '/((?!login|api/login|api/logout|api/build|api/keepalive|api/notify-followups|api/ops/precheck|api/ops/ingest|api/ops/steward|_next/static|_next/image|favicon.ico|manifest.webmanifest|sw.js|icons/).*)',
  ],
};
