...
// any write. Reuses the existing NEXT_PUBLIC_SUPABASE_* env (the same anon creds
// the app already uses). Excluded from the password gate in proxy.ts; instead it
// authenticates cron callers with CRON_SECRET (see below).
